...
/**
 * Servlet implementation class Snoopy
 */
@WebServlet("/Snoopy")
public class Snoopy extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (fName == null || lName == null || email == null || fName.isEmpty() || lName.isEmpty() || email.isEmpty()) {
			...
			response.getWriter().append("<h1 style='color:red'>All fields need to be filled out.</h1>");
		} else {
